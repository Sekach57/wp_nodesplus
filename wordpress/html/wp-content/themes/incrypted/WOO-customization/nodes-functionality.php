...
class ProductRenewalSystem
{
    ...
    public function displayNodesRenewalForm($nodes, $form_id = 'renewal-form') {
        ...
        ?>
        <div id="<?php echo $form_id; ?>" class="renewal-products-form">
            ...
            <form id="renewal-form-submit">
                <?php foreach ($products as $product_data):
                    ...
                    ?>
                    <div class="renewal-product-item">
                        <label>
                            <input type="checkbox"
                            ...
                            <strong><?php echo $node_name; ?></strong>
                            <span class="node-id">(Node ID: <?php echo $node_id; ?>)</span>
                            <span class="price"><?= __('Price', 'incrypted') ?>: <?php echo $product->get_price_html(); ?></span>
                            <span class="created_date"><?php echo __('Created at: ', 'incrypted');
                                $date = new DateTime($product_data['created_at']);
                                echo $date->format('d.m.Y');
                                ?></span>
                            <span class="due_date"><?php echo __('Due date: ', 'incrypted');
